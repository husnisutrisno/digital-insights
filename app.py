        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    className='border-0 bg-danger text-white rounded-lg')
            ])
        ],width=2),
        dbc.Col([
            dbc.Card([
                    ...
                    className='border-0 bg-secondary text-white rounded-lg')
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    className='border-0 bg-info text-white rounded-lg')
            ])
        ], width=2),
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    html.P("Average mobility change on workplaces (last 2 weeks)", className="text-md-center"),
                    className='border-0 bg-warning text-white rounded-lg')
            ])
        ], width=3),
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    className='border-0 bg-dark text-white rounded-lg')
            ])
        ], width=3),
    ]),
